<template>
    <div class="alteracoes-proposta">
        <ul class="collapsible" data-collapsible="expandable">
                ...
                <div class="collapsible-body padding20">
                    <div class="row">
                        <div class="col s12 m6 l6 scroll historico">
                            <salic-proposta-identificacao :idpreprojeto="idpreprojeto"
                                                          :proposta="dadosHistorico"></salic-proposta-identificacao>
                        </div>
                ...
                <div class="collapsible-body padding10">
                    <div class="card padding10">
                        <salic-proposta-historico-avaliacoes
                                :idpreprojeto="idpreprojeto"></salic-proposta-historico-avaliacoes>
                    </div>
                </div>
            </li>
            <li>
            ...
            <li>
                <div class="collapsible-header"
                     v-bind:class="{'orange lighten-4': existe_diferenca(dadosAtuais.FichaTecnica, dadosHistorico.FichaTecnica)}"
                     i>
                    ...
                    <div class="card">
                        <table>
                            <tr>
                                <td class="original historico padding20">
                                    <salic-texto-simples
                                            :texto="dadosHistorico.EspecificacaoTecnica"></salic-texto-simples>
                                </td>
                                <td class="changed atual padding20">
                                    <salic-texto-simples
                                            :texto="dadosAtuais.EspecificacaoTecnica"></salic-texto-simples>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="card">
                        <table>
                            <tr>
                                <td class="original historico padding20">
                                    <salic-texto-simples
                                            :texto="dadosHistorico.DemocratizacaoDeAcesso"></salic-texto-simples>
                                </td>
                                <td class="changed atual padding20">
                                    <salic-texto-simples
                                            :texto="dadosAtuais.DemocratizacaoDeAcesso"></salic-texto-simples>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="card">
                        <table>
                            <tr>
                                <td class="original historico padding20">
                                    <salic-texto-simples
                                            :texto="dadosHistorico.DescricaoAtividade"></salic-texto-simples>
                                </td>
                                <td class="changed atual padding20">
...
<script>
    export default {
        name: "salic-proposta-alteracoes",
        props: [
            'idpreprojeto',
            'dadosAtuais',
            'dadosHistorico'
