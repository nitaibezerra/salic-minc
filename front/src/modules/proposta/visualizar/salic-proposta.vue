<template>
    <div v-if="idpreprojeto || dados" class="proposta">
        <ul class="collapsible" data-collapsible="expandable">
                    ...
                    <div class="row">
                        <div class="col s12 m12 l12 scroll">
                            <salic-proposta-identificacao :idpreprojeto="idpreprojeto"
                                                          :proposta="dados"></salic-proposta-identificacao>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="collapsible-header"><i class="material-icons">subject</i>Democratiza&ccedil;&atilde;o de
                    Acesso
                </div>
                <div class="collapsible-body padding20" v-if="dados">
                    <div class="card padding20">
            ...
            <li>
                <div class="collapsible-header"><i class="material-icons">subject</i>Descri&ccedil;&atilde;o de
                    Atividades
                </div>
                <div class="collapsible-body padding20" v-if="dados">
                    <div class="card padding20">
